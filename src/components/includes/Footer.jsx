        ...
        <Flex w={{ base: '100%', md: '70%', xl: '60%' }} justifyContent='space-between'>
          <Box w='auto' maxW={{ base: '100px', md: '150px', lg: '300px' }}>
            ...
            <Flex flexDir='column'>
              ...
              <Link href='#' fontSize={{ base: 10, md: 12, lg: 14, xl: 16 }} color='gray.300' mb={{ base: 2, md: 6 }} _hover={{ textDecor: 'unset' }}>Propriedades recém construídas</Link>
          ...
          <Box w='auto' maxW={{ base: '100px', md: '150px', lg: '300px' }}>
            ...
            <Flex flexDir='column'> 
              ...
              <Link href='#' fontSize={{ base: 10, md: 12, lg: 14, xl: 16 }} color='gray.300' mb={{ base: 2, md: 6 }} _hover={{ textDecor: 'unset' }}>Fórum</Link>
            </Flex>
          </Box>
          <Box w='auto' maxW={{ base: '100px', md: '150px', lg: '300px' }}>
            <Text fontSize={{ base: 14, md: 16, lg: 20 }} mb={{ base: 6, md: 10 }} color='#fff'>
            ...
            <Flex flexDir='column'>
              <Link href='#' fontSize={{ base: 10, md: 12, lg: 14, xl: 16 }} color='gray.300' mb={{ base: 2, md: 6 }} _hover={{ textDecor: 'unset' }}>Nossa história</Link>
